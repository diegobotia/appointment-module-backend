...
CREATE INDEX idx_notifications_external_entity ON notifications(external_entity_id);
...
CREATE INDEX idx_domain_events_aggregate ON domain_events(aggregate_id, occurred_on);
