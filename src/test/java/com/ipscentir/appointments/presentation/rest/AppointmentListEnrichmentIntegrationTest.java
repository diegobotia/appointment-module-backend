...
class AppointmentListEnrichmentIntegrationTest {
    ...
    void listAppointmentsShouldIncludeDisplayNamesAndAdministrativeFlag() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/appointments")
                ...
                .andExpect(jsonPath("$[?(@.appointmentType == 'PRESENCIAL')].medicoDisplayName")
                        .value("Diana Vargas"))
                .andExpect(jsonPath("$[?(@.appointmentType == 'PRESENCIAL')].patientDisplayName")
                        .value("Maria Lopez"))
                .andExpect(jsonPath("$[?(@.appointmentType == 'PRESENCIAL')].administrative")
                        .value(false))
                .andExpect(jsonPath("$[?(@.appointmentType == 'STAFF')].medicoDisplayName")
                        .value("Diana Vargas"))
                .andExpect(jsonPath("$[?(@.appointmentType == 'STAFF')][0].patientId").doesNotExist())
                .andExpect(jsonPath("$[?(@.appointmentType == 'STAFF')][0].patientDisplayName").doesNotExist())
                .andExpect(jsonPath("$[?(@.appointmentType == 'STAFF')].administrative")
                        .value(true));
    }
